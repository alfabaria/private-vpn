...
****execute below command from your local machine***
```shell
ssh root@<YOUR_VPS_SERVER> "sudo -u apt net-tools; sudo -u wget https://raw.githubusercontent.com/alfabaria/private-vpn/main/install-proxy.sh -O install-proxy.sh; sudo -u chmod +x install-proxy.sh; sudo -u sh install-proxy.sh <PROXY_USERNAME> <PROXY_PASSWORD>;"
```
### Variable
**<YOUR_VPS_SERVER>** : Replace with your VPS ip <br/>
...
****execute below command from your local machine***
```shell
ssh root@<YOUR_VPS_SERVER> -t "sudo -u apt net-tools; sudo -u wget https://raw.githubusercontent.com/alfabaria/private-vpn/main/dante_setup.sh -O dante_setup.sh; sudo -u chmod +x dante_setup.sh; sudo -u bash dante_setup.sh;"
```
### Variable
