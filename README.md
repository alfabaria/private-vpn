...
****execute below command from your local machine***
```shell
ssh root@<YOUR_VPS_SERVER> -t "sudo wget https://raw.githubusercontent.com/alfabaria/private-vpn/main/dante_setup.sh -O dante_setup.sh; sudo chmod +x dante_setup.sh; sudo bash dante_setup.sh;"
```
### Variable
